...
_lr_productions = [
  ...
  ('program -> declaration_list ENDFILE','program',2,'p_root','parser.py',144),
  ('type_specifier -> VOID','type_specifier',1,'p_type_specifier','parser.py',149),
  ('type_specifier -> INT','type_specifier',1,'p_type_specifier','parser.py',150),
  ('declaration_list -> declaration','declaration_list',1,'p_root_statement','parser.py',156),
  ('declaration_list -> declaration_list declaration','declaration_list',2,'p_root_statement','parser.py',157),
  ('declaration -> var_declaration','declaration',1,'p_external_declaration','parser.py',166),
  ('declaration -> function_definition','declaration',1,'p_external_declaration','parser.py',167),
  ('var_declaration -> type_specifier ID COLON','var_declaration',3,'p_var_declaration','parser.py',172),
  ('var_declaration -> type_specifier ID LBRACK NUM RBRACK COLON','var_declaration',6,'p_var_declaration_array','parser.py',178),
  ('function_definition -> type_specifier ID LPAREN params RPAREN compound_statement','function_definition',6,'p_function_definition','parser.py',185),
  ('params -> param_list','params',1,'p_function_declarator_simple','parser.py',191),
  ('params -> VOID','params',1,'p_function_declarator_simple','parser.py',192),
  ('param_list -> parameter_declaration','param_list',1,'p_param_list','parser.py',198),
  ('param_list -> param_list COMMA parameter_declaration','param_list',3,'p_param_list','parser.py',199),
  ('parameter_declaration -> type_specifier ID','parameter_declaration',2,'p_parameter_declaration','parser.py',209),
  ('parameter_declaration -> type_specifier ID LBRACK RBRACK','parameter_declaration',4,'p_parameter_declaration','parser.py',210),
  ('compound_statement -> LCURLY local_declarations statement_list RCURLY','compound_statement',4,'p_compound_statement','parser.py',217),
  ('local_declarations -> local_declarations var_declaration','local_declarations',2,'p_local_declarations','parser.py',223),
  ('local_declarations -> empty','local_declarations',1,'p_local_declarations','parser.py',224),
  ('statement_list -> statement_list statement','statement_list',2,'p_statement_list','parser.py',233),
  ('statement_list -> empty','statement_list',1,'p_statement_list','parser.py',234),
  ('statement -> expression_statement','statement',1,'p_statement','parser.py',243),
  ('statement -> compound_statement','statement',1,'p_statement','parser.py',244),
  ('statement -> selection_statement','statement',1,'p_statement','parser.py',245),
  ('statement -> iteration_statement','statement',1,'p_statement','parser.py',246),
  ('statement -> return_statement','statement',1,'p_statement','parser.py',247),
  ('expression_statement -> expression COLON','expression_statement',2,'p_expression_statement','parser.py',253),
  ('expression_statement -> COLON','expression_statement',1,'p_expression_statement','parser.py',254),
  ('selection_statement -> IF LPAREN expression RPAREN statement','selection_statement',5,'p_selection_statement','parser.py',261),
  ('selection_statement -> IF LPAREN expression RPAREN statement ELSE statement','selection_statement',7,'p_selection_statement','parser.py',262),
  ('iteration_statement -> WHILE LPAREN expression RPAREN statement','iteration_statement',5,'p_iteration_statement','parser.py',269),
  ('return_statement -> RETURN COLON','return_statement',2,'p_return_statement','parser.py',274),
  ('return_statement -> RETURN expression COLON','return_statement',3,'p_return_statement','parser.py',275),
  ('expression -> var ASSIGN expression','expression',3,'p_expression','parser.py',281),
  ('expression -> simple_expression','expression',1,'p_expression','parser.py',282),
  ('var -> ID','var',1,'p_var','parser.py',291),
  ('var -> ID LBRACK expression RBRACK','var',4,'p_var','parser.py',292),
  ('simple_expression -> additive_expression relop additive_expression','simple_expression',3,'p_simple_expression','parser.py',301),
  ('simple_expression -> additive_expression','simple_expression',1,'p_simple_expression','parser.py',302),
  ('relop -> LT','relop',1,'p_relop','parser.py',324),
  ('relop -> LET','relop',1,'p_relop','parser.py',325),
  ('relop -> GT','relop',1,'p_relop','parser.py',326),
  ('relop -> GET','relop',1,'p_relop','parser.py',327),
  ('relop -> EQUALS','relop',1,'p_relop','parser.py',328),
  ('relop -> NEQUALS','relop',1,'p_relop','parser.py',329),
  ('additive_expression -> additive_expression addop term','additive_expression',3,'p_additive_expression','parser.py',335),
  ('additive_expression -> term','additive_expression',1,'p_additive_expression','parser.py',336),
  ('addop -> PLUS','addop',1,'p_addop','parser.py',352),
  ('addop -> MINUS','addop',1,'p_addop','parser.py',353),
  ('term -> term multop factor','term',3,'p_term','parser.py',359),
  ('term -> factor','term',1,'p_term','parser.py',360),
  ('multop -> TIMES','multop',1,'p_multop','parser.py',377),
  ('multop -> DIVIDE','multop',1,'p_multop','parser.py',378),
  ('factor -> LPAREN expression RPAREN','factor',3,'p_factor','parser.py',384),
  ('factor -> var','factor',1,'p_factor','parser.py',385),
  ('factor -> call','factor',1,'p_factor','parser.py',386),
  ('factor -> num_lit','factor',1,'p_factor','parser.py',387),
  ('num_lit -> NUM','num_lit',1,'p_num_lit','parser.py',395),
  ('call -> ID LPAREN args RPAREN','call',4,'p_call','parser.py',399),
  ('args -> arg_list','args',1,'p_args','parser.py',404),
  ('args -> empty','args',1,'p_args','parser.py',405),
  ('arg_list -> arg_list COMMA expression','arg_list',3,'p_arg_list','parser.py',411),
  ('arg_list -> expression','arg_list',1,'p_arg_list','parser.py',412),
  ('empty -> <empty>','empty',0,'p_empty','parser.py',423),
]
